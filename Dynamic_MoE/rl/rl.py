...
class GeneticAlgorithm:
    ...
    def crossover_and_mutation(self, pops, CROSSOVER_RATE=0.8, MUTATION_RATE=0.01, max_inv_fitness=0.01, avg_inv_fitness=0.01):
        new_pop = []
        pop_size = len(pops)
        ...
        for idx, father in enumerate(pops):
            ...
            if max_inv_fitness > avg_inv_fitness:  # 防止除零错误
                ...
                individual_mutation_rate = MUTATION_RATE
            # print(f"child: {child}, inv_fitness: {inv_fitness[idx]}, mutation rate: {individual_mutation_rate}")
